...
disp, force, psi_energy, gf_energy = solve_sav(setup, mat, nat;
    T_final = 1,
...
save("data/plots/load_displacement_sav.png", fig_load)
...
save("data/plots/energy_evolution_sav.png", fig_energy)

println("载荷-位移曲线已保存至 data/plots/load_displacement_sav.png。")
println("能量演变曲线已保存至 data/plots/energy_evolution_sav.png。")

# 保存数据以供后续分析
using JLD2
@save "data/jld2/sav_results.jld2" disp force psi_energy gf_energy
println("SAV 仿真数据已保存至 data/jld2/sav_results.jld2。")